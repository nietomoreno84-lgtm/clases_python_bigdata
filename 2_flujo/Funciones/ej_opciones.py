## hacer un programa en python que permita elegir entre 5 opciones  
        ...
        # 3 - invertir el taxto => tony stark => stark tony
...
def contar_letras(texto):
    ...
    for caracter in resultado:
        if caracter.isalpha():
            contador += 1
    return f"La cantidaad de letras es {contador}"
...
--------------------------------------------------
[1] pasar un texto a minuscula
[2] contar caracateres o letras
[3] invertir el texto introducido
[4] quitar espacios en blanco 
[x] Salir   
"""
    print(menu)
    option = input('¿que opcion quieres hacer?')
